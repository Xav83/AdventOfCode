...
int main(int argc, char** argv)
{
    ...
    const auto openParenthesisCount = std::count(std::begin(fileContent), std::end(fileContent), '(');
    const auto closeParenthesisCount = std::count(std::begin(fileContent), std::end(fileContent), ')');
